...
// ---- 常量 ----
const PLAY_RECORDS_KEY = 'tingbao_play_records';
const FAVORITES_KEY = 'tingbao_favorites';
const SEARCH_HISTORY_KEY = 'tingbao_search_history';

// 缓存相关常量
const CACHE_PREFIX = 'tingbao_cache_';
